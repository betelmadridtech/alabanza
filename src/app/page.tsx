...
const SERVICE_SECTIONS = [
  {
    ...
    items: [
      { id: 'worshipLeader', label: 'Voz 1', req: 'voice', icon: User, emoji: '🎙️' },
      // Indemn Banda (Descomenta si lo quieres activar)
      // { id: 'indemnMain', label: 'Indemn', req: 'indemn', icon: MessageCircle, emoji: '🙏' }, 
      { id: 'voice1', label: 'Voz 2', req: 'voice', icon: Mic, emoji: '🎤' },
      { id: 'voice2', label: 'Voz 3', req: 'voice', icon: Mic, emoji: '🎤' },
      { id: 'voice3', label: 'Voz 4', req: 'voice', icon: Mic, emoji: '🎤' }, 
      { id: 'voice4', label: 'Voz 5', req: 'voice', icon: Mic, emoji: '🎤' },
      { id: 'voice5', label: 'Voz 6', req: 'voice', icon: Mic, emoji: '🎤' }, 
      { id: 'voice6', label: 'Voz 7', req: 'voice', icon: Mic, emoji: '🎤' }, 
